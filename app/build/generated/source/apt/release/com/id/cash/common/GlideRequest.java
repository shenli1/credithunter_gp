...
public class GlideRequest<TranscodeType> extends RequestBuilder<TranscodeType> implements Cloneable {
  ...
  /**
   * @see GlideOptions#roundedCorners(Context, int)
   */
  @CheckResult
  @NonNull
  public GlideRequest<TranscodeType> roundedCorners(@NonNull Context context, int cornerRadius) {
    if (getMutableOptions() instanceof GlideOptions) {
      this.requestOptions = ((GlideOptions) getMutableOptions()).roundedCorners(context, cornerRadius);
    } else {
      this.requestOptions = new GlideOptions().apply(this.requestOptions).roundedCorners(context, cornerRadius);
    }
    return this;
  }
