...
public final class GlideOptions extends RequestOptions implements Cloneable {
  ...
  /**
   * @see SWGlideExtension#roundedCorners(RequestOptions, Context, int)
   */
  @CheckResult
  @NonNull
  public GlideOptions roundedCorners(@NonNull Context context, int cornerRadius) {
    return (GlideOptions) SWGlideExtension.roundedCorners(this, context, cornerRadius);
  }
   ...
   */
  @CheckResult
  public static GlideOptions roundedCornersOf(@NonNull Context context, int cornerRadius) {
    return new GlideOptions().roundedCorners(context, cornerRadius);
  }
}
